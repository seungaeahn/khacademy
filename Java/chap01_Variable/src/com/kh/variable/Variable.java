...
public class Variable {
	public static void main(String[] args) {
		...
		// 3. 변수 이름사이에는 공백을 포함할 수 없다.
		// int a b c = 1; 언어의 규칙으로 띄어쓰기는 무언가 새로 시작할 때 사용하기 때문에 사용하지 않는다.
		
		// 4. 자바에서 미리 예약한 언어는 변수 이름으로 사용하지 못한다.
		// int int = 1;
		
		
		// 1. 실수형 (소주점이 있는 숫자: float, double)
		float pie1 = 3.14159222222222f; //float는 f나 대문자F를 작성해준다.
		...
		// 2. 정수형
		// byte :-128 ~ 127 까지 사용 가능
		// byte bt = -129; int로 번경하거나 값을 byte+byte로 바꿔주어야 한다.
		byte bt = 127; // -129와 128이상부터 출력이 되지 않는 것 확인 
		System.out.println(bt);
		
		// short : -32,768 ~ 32,767까지 사용 가능
		// short shrt = -32769; -32769와 32768이후 출력되지 않음 
		short shrt = -32767;
		System.out.println(shrt);
		
		// int : -2,147,483,648 ~ 2,147,483,647 까지 사용 가능
		// int nt = -2147483649;
		int nt = -2147483648;
		...
		// String은 기본적인 자료형에 들어가지는 않으나 기본적으로 사용됨. 기본적인 자료형에 들어가지 않기 때문에 String으로 표현됨 
		// String ""나 ''안에 글자를 작성 
		String name1 = "안녕하세요.";
		
		// 4. 논리형
		//boolean은 true와 false를 표현한다.
		// 사용방법 boolean bln = true; 또는 false;
		boolean bln = true;
