...
public class Comparison {
	...
	public static void main(String[] args) {
		// 4. 비교 연산자 : 값을 비교할 때 사용
		/*
		 크기 비교, 등호 비교 등을 수행할 수 있음 
		 두개의 항 중 어느것이 더 큰지, 더 작은지, 다른지의 여부를 판단 
		 비교 연산자의 결과값은 참(true) 또는 거짓(false)로 변환
		...
		System.out.println("p != q: " + isEqual1); //p와 q의 닶이 다르게 나오기 때문에 true 출력 
		
		boolean isEqual2 = p != r ;
		System.out.println("p != r: " + isEqual2); //p와 r의 값이 같게 나오기 때문에 false 출력
