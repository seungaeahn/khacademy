 ...
 * 층별 순회 : 위쪽 node들부터 아래 방향으로 차례대로 방문 
 */
public class BinaryTree {
	...
	//재귀적: 자기 자신을 표현하고 다시 자기 자신을 사용해서 정의 내림 
	 ...
	 * 왼쪽 서브 트리 현재노드 오른쪽 서브 트리 순서로 노드 출력 
	 */
	public void inOrderTraversal() { //inOrder Traversal 중위 순회
		inOrderTR(root);
	}
