...
public class InetAddressMain {
	...
	public void InetExam() {
		try {
			...
			//내가 사용하는 컴퓨터의 InetAddress 객체 열기 
	...
	public void InetSample() {
		...
		try {
			...
			System.out.println("구글에 지정된 노든 호스트의 아이피 주소를 배열로 얻음");
			...
			InetAddress name = InetAddress.getByName("www.daum.com");
			...
			System.out.println("룩펙인가요 : " + isLookPack);
		} catch (UnknownHostException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
